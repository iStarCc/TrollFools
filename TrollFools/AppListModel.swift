...
final class AppListModel: ObservableObject {
    ...
    func performFilter() {
        ...
        filteredApplications.sort { app1, app2 in
            ...
            case .descending:
                return app1.name.localizedCaseInsensitiveCompare(app2.name) == .orderedDescending
            }
        }
    ...
    var displayedApplications: [App] {
        switch selectedFilter {
        case .all:
            return userApplications + trollApplications + appleApplications
        case .user:
            return userApplications
        case .troll:
            return trollApplications
        case .system:
